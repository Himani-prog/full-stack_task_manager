...
export const menuItems = [
    { text: "Dashboard", path: "/", icon: <Home className="w-5 h-5 m-2" /> },
    { text: "Pending Tasks", path: "/pending", icon: <ListChecks className="w-5 h-5 m-2" /> },
    { text: "Completed Tasks", path: "/complete", icon: <CheckCircle2 className="w-5 h-5 m-2" /> },
]
