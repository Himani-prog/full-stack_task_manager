                ...
                <div className=' grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6' >
                    ...
                    <div className=' xl:col-span-1 space-y-4 sm:space-y-6'>
                        <div className=' bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
                            ...
                            <div className=' grid grid-cold-2 gap-3 sm:gap-4 mb-4 sm:mb-6'>
                            ...
                            <div className=' space-y-2 sm:space-y-3'>
                                <div className=' flex items-center justify-between text-gray-700'>
                                    ...
                                    <span className=' text-xs bg-purple-100 text-purple-700 px-1.5 py-0.5 sm:px-2 roumded-full'>
                            ...
                            <div className=' space-y-2 sm:space-y-3'>
                                {tasks.slice(0, 3).map((task) => (
                                    <div key={task._id || task.id} className=' flex items-center justify-between p-2 sm:p-3 hover:bg-purple-50/50
                                        rounded-lg transition-colors duration-200 border border-transparent hover:border-purple-100'>
                                        <div className=' flex-1 min-w-0'>
                                            <p className=' text-sm font-medium text-gray-700 break-words whitespace-normal'>
                                                {task.title}
                                            </p>
                                            <p className=' text-xs text-gray-500 mt-0.5'>
                                                {task.createdAt ? new DataTransfer(task.createdAt).toLocaleDateString() : "No Date"}
                                            </p>
                                        </div>
